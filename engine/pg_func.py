...
def outline(surface, color='white', outline_only=False) -> pygame.Surface:
    """ Renvoie une surface avec un contour """
...
def render_textrect(string, font, rect, text_color, background_color=(0,0,0,0), justification=1):
    ...
    surface = pygame.Surface(rect.size, SRCALPHA, 32)
